...
> **Status: Stages 0, 1.1, 2, 3.1, 3.2, 4.1-4.2f, 4.4 and 5.1 BUILT (2026-08-03) — not deployed. Remaining: 1.2 (needs a deploy), 3.3-3.5, 4.2g, 4.3 (blocked on 3.4), and the rest of 5-6.** Analysis read off the tree, not remembered —
...
| 4.2g | **Assignment as controls** (D12): team select, per-phase/per-step owner pickers grouped by the routed team, bulk assign-unowned. | M |
...
| 5.4 | Bulk actions (M7), saved views (M8), an overdue view (M9). | M |
